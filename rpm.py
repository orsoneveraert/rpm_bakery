...
# Load mixers from cookies
if 'mixers' in cookies:
    st.session_state.mixers = json.loads(cookies['mixers'])

def save_mixers():
    cookies['mixers'] = json.dumps(st.session_state.mixers)
    cookies.save()
